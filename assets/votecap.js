...
function getURL() {
	return 'index.php?NOAUTH&type=module&pid='+getParameterByName('pid')+'&sid='+getParameterByName('sid')+'&prefix='+getParameterByName('prefix')+'&page='+getParameterByName('page');
}
